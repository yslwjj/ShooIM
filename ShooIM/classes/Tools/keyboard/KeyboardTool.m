...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.frame=CGRectMake(0, 0, SAMScreenW, 44);
        ...
        _finished.backgroundColor= [UIColor lightGrayColor];  // Color(209, 213, 219);
        [_finished setTitle:@"完成" forState:UIControlStateNormal];
        _finished.frame=CGRectMake(SAMScreenW-60, 5, 55, 35);
